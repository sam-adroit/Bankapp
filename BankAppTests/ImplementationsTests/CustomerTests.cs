...
namespace BankAppTests.ImplementationsTests
{
    ...
    public class CustomerTests
    {
        ...
        public void GetAllCustomerAccounts_WhenUserIdDoesNotExist_ReturnZero()
        {
            ...
            var result = _customer.GetAllCustomerAccounts(55, "Samuel");
        ...
        public void GetAllCustomerAccounts_WhenUserIdExist_ReturnTrue()
        {
            ...
            _accountData.Setup(ad => ad.GetAccountsByUserId(4)).Returns(new List<AccountModel> { new AccountModel { AccountNo = "0123456789", AccountType = "Savings", Balance = 3000.0, userId = 4, TransactionList = new List<TransactionModel> { new TransactionModel { Balance = 5000, Amount = 500, Date = "10/2/2020", Description = "Good" } } } });
            var result = _customer.GetAllCustomerAccounts(4, "Samuel");
